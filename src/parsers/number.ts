...
const serializeInternalUint8 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setUint8')
...
const serializeInternalInt8 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setInt8')
    return indexInBuffer + 1;
};
...
const serializeInternalUint16 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setUint16')
    return indexInBuffer + 2;
};
...
const serializeInternalInt16 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setInt16')
    return indexInBuffer + 2;
};
...
const serializeInternalUint32 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setUint32')
    return indexInBuffer + 4;
};
...
const serializeInternalInt32 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setInt32')
    return indexInBuffer + 4;
};
...
const serializeInternalFloat32 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setFloat32')
    return indexInBuffer + 4;
};
...
const serializeInternalBigUint64 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setBigUint64')
    return indexInBuffer + 8;
};
...
const serializeInternalBigInt64= (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setBigInt64')
    return indexInBuffer + 8;
};
...
const serializeInternalFloat64 = (value, dataView, indexInBuffer) => {
    pushToDataView(dataView, indexInBuffer, value, 'setFloat64')
    return indexInBuffer + 8;
};
